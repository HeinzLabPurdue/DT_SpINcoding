...
data_an$OnRate_rel <- data_an$OnRate - data_an$SpontRate
data_an$SusRate_rel <- data_an$SusRate - data_an$SpontRate
data_an_HF$OnRate_rel <- data_an_HF$OnRate - data_an_HF$SpontRate
data_an_HF$SusRate_rel <- data_an_HF$SusRate - data_an_HF$SpontRate
