function [legend_h,object_h,plot_h,text_strings] = columnlegend(lineHan, numcolumns, str, varargin)
%
...
if legend_h == false,
    ...
    if ~isempty(extravars)
        [legend_h,object_h,plot_h,text_strings] = legend(lineHan, str, extravars{:});
    else
        [legend_h,object_h,plot_h,text_strings] = legend(lineHan, str);
    end
end
