...
for comboVar=1:length(wind_cost_combo)
    ...
    if rem(1/anl.VPcosts*1e3, 1)==0
        txtHan(comboVar)= text(.5, 1.01, sprintf('2/q= %.0f ms', 2/anl.VPcosts*1e3), 'units', 'normalized', 'Interpreter', 'tex', 'HorizontalAlignment', 'center');
    elseif rem(1/anl.VPcosts*1e3*10, 1)==0
         txtHan(comboVar)= text(.5, 1.01, sprintf('2/q= %.1f ms', 2/anl.VPcosts*1e3), 'units', 'normalized', 'Interpreter', 'tex', 'HorizontalAlignment', 'center');
    else 
         txtHan(comboVar)= text(.5, 1.01, sprintf('2/q= %.2f ms', 2/anl.VPcosts*1e3), 'units', 'normalized', 'Interpreter', 'tex', 'HorizontalAlignment', 'center');
    end
    ttlHan(comboVar)= text(.05, 0.95, spLetters(comboVar), 'units', 'normalized', 'Interpreter', 'tex', 'HorizontalAlignment', 'center');
