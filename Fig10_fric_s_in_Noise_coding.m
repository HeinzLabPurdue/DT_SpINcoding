...
dirStruct.png= [pwd filesep 'final_figs_eps' filesep];
...
ylabHan_PSD= ylabel('PSD (dB/Hz)');
xlabHan_PSD= xlabel('Frequency (kHz)');
...
text(-.11, 1.05, 'x10^3', 'Units', 'normalized');
...
xlabel('Characteristic frequency (kHz)', 'FontSize', plt.fSize_lab);
set(ttlHan,'FontSize', 10);
set(ylab_tc_han, 'FontSize', plt.fSize_lab);
set(xlabHan_PSD, 'FontSize', plt.fSize_lab);
set(ylabHan_PSD, 'FontSize', plt.fSize_lab);
...
axes(sp_ax(5));
ylab_rate_han= ylabel('Rate (spikes/s)', 'Units', 'normalized', 'FontSize', plt.fSize_lab);
ylab_rate_han.Position(2)= 1.1;

axes(sp_ax(4));
ylabel('Fricative-coding fidelity', 'FontSize', plt.fSize_lab);


axes(sp_ax(5));
xlabel('Time (sec)', 'FontSize', plt.fSize_lab);
...
%         print([dirStruct.png 'Fig8_fric_SpIN'], '-dpng',  '-r600');
        print([dirStruct.eps 'Fig8_fric_SpIN'], '-depsc');
    else
